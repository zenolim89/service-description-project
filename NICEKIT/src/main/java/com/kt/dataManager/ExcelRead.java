...
public class ExcelRead {
	...
	public static List<ExcelUploadForm> read(ExcelReadOption excelReadOption, String domainName, String domainId, String specName) {
...
//				 }
			...
			// Intent 정보
			if(format.get("intentInfo") != null) form.setIntentInfo(cellReader(sheet, format.get("intentInfo")));
			if(format.get("dicList") != null) form.setDicList(bindDicParam(sheet, format.get("dicList")));
