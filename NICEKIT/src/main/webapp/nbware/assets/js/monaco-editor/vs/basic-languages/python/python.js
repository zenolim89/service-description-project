				...
				var t = "undefined" == typeof monaco ? self.monaco : monaco;
							...
							n.language = {
									...
									keywords : [ "and", "as", "assert", "break", "class",
												...
												"or", "pass", "print", "raise", "return", "self",
												"try", "while", "with", "yield", "int", "float",
												"long", "complex", "hex", "abs", "all", "any",
												...
												"execfile", "file", "filter", "format",
												"frozenset", "getattr", "globals", "hasattr",
												"hash", "help", "id", "input", "intern",
												"isinstance", "issubclass", "iter", "len",
												"locals", "list", "map", "max", "memoryview",
												"min", "next", "object", "oct", "open", "ord",
												"pow", "print", "property", "reversed", "range",
												...
												"xrange", "zip", "True", "False", "__dict__",
												"__methods__", "__members__", "__class__",
												"__bases__", "__name__", "__mro__",
